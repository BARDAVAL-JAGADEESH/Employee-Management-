...
public class UpdateEmployee extends JFrame implements ActionListener{
    ...
    JTextField Teducation, Tfname, Taddress, Tphone, tfaadhar, Temail, Tsalary, Tdesignation;
    JLabel JempId;
    JButton add, back;
    String empId;
    ...
    UpdateEmployee(String empId) {
        ...
        JLabel Jeducation = new JLabel("Higest Education");
        Jeducation.setBounds(400, 300, 150, 30);
        Jeducation.setFont(new Font("serif", Font.PLAIN, 20));
        add(Jeducation);
        ...
        JempId = new JLabel();
        JempId.setBounds(200, 400, 150, 30);
        JempId.setFont(new Font("serif", Font.PLAIN, 20));
        add(JempId);
